...
class QTV_Email_Template {
    ...
    public function __construct() {
        ...
        add_action('admin_menu', [$this, 'qtv_email_builder_admin_menu'], 9999);
        add_action('admin_enqueue_scripts', [$this, 'angular_dashboard_embed_scripts']);
    }
    ...
    function qtv_email_builder_admin_menu() {
        add_menu_page(
            ...
            'manage_options',
            'qtv-email-welcome',
            [$this, 'qtv_email_manager_welcome'],
            'dashicons-email',
            10
        );
        ...
        add_submenu_page(
            ...
            'manage_options',
            'qtv-email-welcome',
            [$this, 'qtv_email_manager_dashboard'],
        );
    ...
    function qtv_email_manager_dashboard() {
        echo '<div class="wraps"><div id="qtv-angular-app"><app-root></app-root></div></div>';
    }

    function qtv_email_manager_welcome(){
        include plugin_dir_path(__DIR__) . 'templates/welcome.php';
    }

    function angular_dashboard_embed_scripts($hook) {
        if ($hook !== 'email-builder_page_qtv-email-manager') {
            return;
        }
        
        $plugin_url = plugin_dir_url(__FILE__);
        $angular_base = $plugin_url . 'view/';
